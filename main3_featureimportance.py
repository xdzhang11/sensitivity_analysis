...
for k in range(3):
    ...
    shap.summary_plot(shap_values, X_test, feature_names=bars, plot_size=(12,4) ,show=False, title=False)
    ...
    shap.summary_plot(shap_values, X_test, feature_names=bars, plot_size=(12,4), plot_type="bar", show=False)
    ax = plt.gca()
    ax.set_xlabel('')
